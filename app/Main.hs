...
draw (room, ball) = pictures [drawRoom room, drawBall ball, drawData ball]
...
drawRoom room = pictures
  [ drawWall (top room)
  , drawWall (right room)
  , drawWall (bottom room)
  , drawWall (left room)
  ]

drawWall :: Wall -> Picture
drawWall wall = color white $ line [from wall, to wall]
